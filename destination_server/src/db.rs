...
pub fn get_sample_db() -> Result<DbPool, SampleServerError> {
...
pub fn get_subdomain_db(subdomain: &str, pass: &str) -> Result<DbPool, SampleServerError> {
...
pub fn create_subdomain_db(conn: &DbPool, pass: &str) -> Result<(), DirsqlError> {
